...
class Vocabulary(object):
    ...
    def __init__(self, init_from_file=None, max_length=140):
        ...
        self.special_tokens = ['EOS', 'GO', 'is_GSK3', 'not_GSK3', 'is_JNK3', 'not_JNK3', 'high_QED', 'low_QED',
                               'good_SA', 'bad_SA']
...
class MolData(Dataset):
    ...
    def condition_convert(self, con_df):
        ...
        # convert to token
        con_df['jnk3'][con_df['jnk3'] == 1] = 'is_JNK3'
        con_df['jnk3'][con_df['jnk3'] == 0] = 'not_JNK3'
        con_df['gsk3'][con_df['gsk3'] == 1] = 'is_GSK3'
        con_df['gsk3'][con_df['gsk3'] == 0] = 'not_GSK3'
